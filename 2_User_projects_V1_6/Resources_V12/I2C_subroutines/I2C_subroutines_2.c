...
s[0] = '0'; num_bytes=8; mode = 1;
I2C_Tx(num_bytes,mode, s); break;
case 'D': num_bytes=8; mode = 'F';
I2C_Tx(num_bytes,mode, s); break;
case 'N': for (int m = 0; m < 8; m++)s[m] = 0;
s[0] = '0'; num_bytes=8; mode = 'F';
I2C_Tx(num_bytes,mode, s); break;
